...
```{r}
GAEZ_France <- readRDS("data/raw/GAEZ_yieldchange_communes_filt(2).rds")
...
# cultures du thème 3 : Napier Grass, Grass and Yam only present in theme 3

list(unique(GAEZ_France_th3$crop))
